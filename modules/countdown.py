...
class Countdown(Module):
    ...
    events = [
        Event("Days On Campus 1", datetime.datetime(year=2019, month=4, day=7), datetime.timedelta(days=2)),
		Event("Days On Campus 2", datetime.datetime(year=2019, month=4, day=14), datetime.timedelta(days=2)),
        Event("NSOP", datetime.datetime(year=2019, month=8, day=26), datetime.timedelta(days=7)),
    ]
